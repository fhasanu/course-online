    ...
    <div class="panel panel-danger sharp-box space-item course">
        <div class="panel-body row">
            ...
            <div class="parent col-lg-8 col-md-8 col-sm-8 col-xs-8">
                ...
                <h2 class="float-normal">{{ $course->ak_subcat_name }}   <span class="label label-success">{{ $course->ak_course_level_name }}</span>  <span class="label label-primary">{{ $course->ak_course_age_name_ind }}</span></h2>
